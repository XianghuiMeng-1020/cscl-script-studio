...
const I18N = {
    'zh-CN': {
        ...
        // Wizard
        'teacher.wizard.step1': '上传材料',
        'teacher.wizard.step2': '定义活动',
        ...
        'teacher.wizard.step1.drag': '将文件拖放到此处，或点击浏览（可多选）',
        ...
        'teacher.wizard.step1.uploaded_files': '已上传的文件',
        'teacher.wizard.step1.no_uploaded_yet': '暂无已上传文件',
        ...
        // Form Labels
        'teacher.form.initial_idea': '对本次活动有什么初步想法？（选填）',
        'teacher.form.initial_idea_help': '简单描述你的想法、偏好或顾虑即可，不必写很长。',
        ...
        'teacher.form.whole_class_reporting_help': '活动结束后是否需要全班汇报或分享小组结论（如口头汇报、张贴结论、投票等）。',
        ...
        'teacher.form.default_outputs': '默认输出材料',
        'teacher.form.default_outputs_help': '学生工作表：学生端活动工作表，含任务说明、记录区、引导问题。学生幻灯片：活动说明幻灯片（非全课 PPT），聚焦活动步骤与目标。教师引导单：教师端引导手册，含实施方式、对齐目标、关注要点。',
        'teacher.form.output_worksheet': '学生工作表',
        'teacher.form.output_slides': '学生幻灯片',
        'teacher.form.output_teacher_guide': '教师引导单',
        'teacher.form.task_requirements': '活动具体要求（选填）',
    ...
    'zh-TW': {
        ...
        // Wizard
        'teacher.wizard.step1': '上傳材料',
        'teacher.wizard.step2': '定義活動',
        'teacher.wizard.step3': '生成',
        ...
        'teacher.wizard.step1.drag': '將檔案拖放到此處，或點擊瀏覽（可多選）',
        ...
        'teacher.wizard.step1.uploaded_files': '已上傳的檔案',
        'teacher.wizard.step1.no_uploaded_yet': '暫無已上傳檔案',
        ...
        // Form Labels
        'teacher.form.initial_idea': '對本次活動有什麼初步想法？（選填）',
        'teacher.form.initial_idea_help': '簡單描述你的想法、偏好或顧慮即可，不必寫很長。',
        ...
        'teacher.form.whole_class_reporting_help': '活動結束後是否需要全班彙報或分享小組結論（如口頭彙報、張貼結論、投票等）。',
        ...
        'teacher.form.default_outputs': '預設輸出材料',
        'teacher.form.default_outputs_help': '學生工作表：學生端活動工作表，含任務說明、記錄區、引導問題。學生幻燈片：活動說明幻燈片（非全課 PPT），聚焦活動步驟與目標。教師引導單：教師端引導手冊，含實施方式、對齊目標、關注要點。',
        'teacher.form.output_worksheet': '學生工作表',
        'teacher.form.output_slides': '學生幻燈片',
        'teacher.form.output_teacher_guide': '教師引導單',
        'teacher.form.task_requirements': '活動具體要求（選填）',
    ...
    'en': {
        ...
        // Wizard
        'teacher.wizard.step1': 'Upload Materials',
        'teacher.wizard.step2': 'Define Activity',
        ...
        'teacher.wizard.step1.drag': 'Drag and drop files here, or click to browse (multiple allowed)',
        ...
        'teacher.wizard.step1.uploaded_files': 'Uploaded files',
        'teacher.wizard.step1.no_uploaded_yet': 'No files uploaded yet',
        ...
        // Form Labels
        'teacher.form.initial_idea': 'Any initial idea for the group activity? (optional)',
        'teacher.form.initial_idea_help': 'Briefly describe any idea, preference, or concern you already have for this activity.',
        ...
        'teacher.form.whole_class_reporting_help': 'Whether the activity should end with whole-class reporting or sharing of group conclusions (e.g. oral report, poster, vote).',
        ...
        'teacher.form.default_outputs': 'Default outputs',
        'teacher.form.default_outputs_help': 'Student worksheet: student-facing handout for the activity (task prompt, notes, guiding questions). Student slides: activity slides (not full lecture), steps and goals. Teacher facilitation sheet: teacher guide (implementation, alignment, what to watch for).',
        ...
        'teacher.form.task_requirements': 'Activity requirements (optional)',
